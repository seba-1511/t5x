...
python3 ./t5x/scripts/xm_launch.py --gin_file=t5x/examples/t5/t5_1_1/examples/base_wmt_from_scratch.gin --model_dir=./models --tfds_data_dir=/media/seba-1511/OCZ/data/
```
